...
import sys
if 'turtle' in sys.argv: from world.turtle import world
...
def robot_start():
    ...
    obstacles.FillWithObstacles()
    global position_x, position_y, current_direction_index, history,directions

    robot_name = get_robot_name()
    output(robot_name, "Hello kiddo!")

    if 'turtle' not in sys.argv: obstacles.ShowObstacles()
